...
namespace
{
    ...
    bool CApplication::InternOnCreateMeshes()
    {
        ...
        MeshInfo.m_pNormals         = &s_QuadNormals[0][0];
        MeshInfo.m_pColors          = &s_QuadColors[0][0];
