...
namespace
{
    class CApplication : public IApplication
    {
        ...
        private:
            ...
            BHandle m_pTriangleTexture; // A pointer to a YoshiX texture, which is part of the material covering the triangle.
...
namespace
{
    ...
    bool CApplication::InternOnCreateTextures()
    {
        ...
        // the image.
        // -----------------------------------------------------------------------------
        CreateTexture("..\\data\\images\\wall.dds", &m_pTriangleTexture);
    ...
    bool CApplication::InternOnReleaseTextures()
    {
        ...
        // -----------------------------------------------------------------------------
        ReleaseTexture(m_pTriangleTexture);
